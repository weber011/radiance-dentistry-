        ...
        <div className="container">
          ...
          <div className="tech-showcase-list">
            {[
              ...
              { id: "chairs", name: "Modern Dental Chairs", image: "modern_dental_chair.png", desc: "Ergonomically designed chairs featuring plush memory foam to keep you relaxed during longer procedures.", benefits: ["Maximum relaxation", "Ergonomic support", "Reduced anxiety"] }
            ].map((tech, idx) => (
